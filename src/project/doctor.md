...
中间区域选择科室，抽离组件 `DepartmentContent.vue`
...
定义下拉菜单选项，双向数据绑定的值 `ConsultDoctorList.vue`
...
## 医生列表-区域选择[#](https://zhousg.github.io/patient-h5-note/project/doctor.html#医生列表-区域选择)
...
下拉菜单区域结构布局 `ConsultDoctorList.vue`
...
发送计算就诊信息和抵扣信息请求，字段判断处理 `ConsultPay`
...
页面结构处理 `ConsultDoctorDetail.vue`
